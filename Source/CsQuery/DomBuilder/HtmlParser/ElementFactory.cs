...
namespace CsQuery.HtmlParser
{
    ...
    class ElementFactory
    {
        ...
        private void InitializeTreeBuilder()
        {
            ...
            treeBuilder.WantsComments = (HtmlParsingOptions & HtmlParsingOptions.IgnoreComments) == 0;// !HtmlParsingOptions.HasFlag(HtmlParsingOptions.IgnoreComments);
            treeBuilder.AllowSelfClosingTags = (HtmlParsingOptions & HtmlParsingOptions.AllowSelfClosingTags) != 0;// &HtmlParsingOptions.HasFlag(HtmlParsingOptions.AllowSelfClosingTags);
