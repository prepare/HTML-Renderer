...
using CsQuery.Implementation.Mono;
...
namespace CsQuery.Implementation
{
    ...
    class RangeSortedDictionary<TKey, TValue> : IRangeSortedDictionary<TKey, TValue> where TKey : IConvertible, IComparable
    {
        ...
        public IEnumerable<TKey[]> GetRangeKeys(TKey[] subkey)
        {
            ...
            TKey[] lastKey = ConcatArray(subkey, IndexSeparator);// subkey.Concat(IndexSeparator).ToArray();
        ...
        static T[] ConcatArray<T>(T[] a1, T a2)
        {
            int newLen = a1.Length + 1;
            T[] newArray = new T[newLen];
            Array.Copy(a1, newArray, a1.Length);
            newArray[newLen - 1] = a2;
            return newArray;
        }
        /// <summary>
